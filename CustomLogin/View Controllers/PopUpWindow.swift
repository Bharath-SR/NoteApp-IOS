...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        // Popup Background
        popupView.backgroundColor = UIColor.colorFromHex("#C7417b")
        ...
        popupTitle.backgroundColor = UIColor.colorFromHex("#8F3B76")
        ...
        popupButton.backgroundColor = UIColor.colorFromHex("#8F3B76")
